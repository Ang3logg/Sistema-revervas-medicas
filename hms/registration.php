...
<script type="text/javascript">
	function valid() {
		...
		if (!passwordPattern.test(password)) {
			alert("La contraseña debe tener al menos una letra mayúscula, un carácter especial (@$!%*?&) y una longitud mínima de 8 caracteres.");
			return false;
		}
	...
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="logo margin-top-30">
				<a href="../index.html">
					<h2>HSP | Registro de pacientes</h2>
				</a>
			</div>
			<!-- start: REGISTER BOX -->
					...
					<fieldset>
						...
						<div class="form-group">
							<span class="input-icon">
								...
								<p>Su contraseña debera tener un carácter especial (@$!%*?&)</p>
						</div>
						<div class="form-group">
							<span class="input-icon">
